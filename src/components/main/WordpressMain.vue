...
export default {
  ...
  methods: {
    async initPage() {
      ...
      console.log("WordpressMain初始化页面,meta=>", this.siyuanData.meta);
    },
    ...
    async publishPage() {
      await publishMdContent(this.siyuanData.pageId, PUBLISH_TYPE_CONSTANTS.API_TYPE_WORDPRESS, this.siyuanData.meta)
    }
  }
}
</script>
